            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="tb_group" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
...
<script>
    ...
    $(document).ready(function() {
        tabel = $('#tb_group').DataTable({
            ...
            "ajax": {
                "url": BASE_URL + "admin/role/view_data", // URL file untuk proses select datanya
                "type": "POST"
            },
            "deferRender": true,
            "aLengthMenu": [
    ...
    $(document).off("click", "#tb_group button.edit")
        .on("click", "#tb_group button.edit", function(e) {
            $.ajax({
                type: "POST",
                ...
                success: function(data) {
                    if (data.status == 1) {
                        data = data.data;
                        $('input[name="grp_id"]').val(data.grp_id);
    ...
    $(document).off("click", "#tb_group button.hapus")
        .on("click", "#tb_group button.hapus", function(e) {
            $.ajax({
                type: "POST",
    ...
    function getMenu(grp_id = null) {
        $.ajax({
            ...
            success: function(data) {
                ...
                if (grp_id) {
                    $('#tb_menu tbody').append('<input type="hidden" name="grp_id" value="' + grp_id + '">');
                }
            }
        });
    }
